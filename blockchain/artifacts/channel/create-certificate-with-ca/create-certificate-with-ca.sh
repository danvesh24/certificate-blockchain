createcertificatesForsuperadmin() {
  ...
  fabric-ca-client enroll -u https://admin:adminpw@localhost:13054 --caname ca.superadmin.certs.com --tls.certfiles ${PWD}/fabric-ca/superadmin/tls-cert.pem

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-13054-ca-superadmin-certs-com.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:13054 --caname ca.superadmin.certs.com -M ${PWD}/../crypto-config/peerOrganizations/superadmin.certs.com/peers/peer0.superadmin.certs.com/msp --csr.hosts peer0.superadmin.certs.com --tls.certfiles ${PWD}/fabric-ca/superadmin/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:13054 --caname ca.superadmin.certs.com -M ${PWD}/../crypto-config/peerOrganizations/superadmin.certs.com/peers/peer0.superadmin.certs.com/tls --enrollment.profile tls --csr.hosts peer0.superadmin.certs.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/superadmin/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://user1:user1pw@localhost:13054 --caname ca.superadmin.certs.com -M ${PWD}/../crypto-config/peerOrganizations/superadmin.certs.com/users/User1@superadmin.certs.com/msp --tls.certfiles ${PWD}/fabric-ca/superadmin/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://superadminadmin:superadminadminpw@localhost:13054 --caname ca.superadmin.certs.com -M ${PWD}/../crypto-config/peerOrganizations/superadmin.certs.com/users/Admin@superadmin.certs.com/msp --tls.certfiles ${PWD}/fabric-ca/superadmin/tls-cert.pem
...
createCertificatesForcompany() {
  ...
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-14054-ca-company-certs-com.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-14054-ca-company-certs-com.pem
    OrganizationalUnitIdentifier: peer
  ...
  echo "## Generate the peer0 msp"
  echo
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:14054 --caname ca.company.certs.com -M ${PWD}/../crypto-config/peerOrganizations/company.certs.com/peers/peer0.company.certs.com/msp --csr.hosts peer0.company.certs.com --tls.certfiles ${PWD}/fabric-ca/company/tls-cert.pem
  ...
  echo "## Generate the peer0-tls certificates"
  echo
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:14054 --caname ca.company.certs.com -M ${PWD}/../crypto-config/peerOrganizations/company.certs.com/peers/peer0.company.certs.com/tls --enrollment.profile tls --csr.hosts peer0.company.certs.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/company/tls-cert.pem
  ...
  echo "## Generate the user msp"
  echo
  fabric-ca-client enroll -u https://user1:user1pw@localhost:14054 --caname ca.company.certs.com -M ${PWD}/../crypto-config/peerOrganizations/company.certs.com/users/User1@company.certs.com/msp --tls.certfiles ${PWD}/fabric-ca/company/tls-cert.pem
  ...
  echo "## Generate the org admin msp"
  echo
  fabric-ca-client enroll -u https://companyadmin:companyadminpw@localhost:14054 --caname ca.company.certs.com -M ${PWD}/../crypto-config/peerOrganizations/company.certs.com/users/Admin@company.certs.com/msp --tls.certfiles ${PWD}/fabric-ca/company/tls-cert.pem
